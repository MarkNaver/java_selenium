...
import WebDriverApiInstance.Screenshots2;
...
import testSuite.ExtentFactory;
...
//        driver = new ChromeDriver();
        ...
        searchPage = new SearchPageFactory(driver2,test);
...
//        test.log(LogStatus.PASS,"Case执行成功");
        boolean result = searchPage.isTitleBarPresent();
    ...
    public void tearDown(ITestResult result) throws Exception {
        ...
        if (result.getStatus() == ITestResult.FAILURE) {
            String path =  Screenshots2.takeScreenshots(driver2, result.getName());
