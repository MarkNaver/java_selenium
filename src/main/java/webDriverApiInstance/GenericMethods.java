...
//        List<WebElement> elementList = new ArrayList<WebElement>();
        if (type.equals("id")) {
            LoggerDemoOne.Output(LogType.LogTypeName.INFO, "用id查找元素:" + locator);
            return this.driver.findElement(By.id(locator));
        } else if (type.equals("xpath")) {
            LoggerDemoOne.Output(LogType.LogTypeName.INFO, "用xpath查找元素:" + locator);
            return this.driver.findElement(By.xpath(locator));
        } else if (type.equals("css")) {
            LoggerDemoOne.Output(LogType.LogTypeName.INFO, "用css查找元素:" + locator);
            return this.driver.findElement(By.cssSelector(locator));
        } else if (type.equals("name")) {
            LoggerDemoOne.Output(LogType.LogTypeName.INFO, "用name查找元素:" + locator);
            return this.driver.findElement(By.name(locator));
        } else if (type.equals("classname")) {
            LoggerDemoOne.Output(LogType.LogTypeName.INFO, "用classname查找元素:" + locator);
            return this.driver.findElement(By.className(locator));
        } else if (type.equals("tagname")) {
            LoggerDemoOne.Output(LogType.LogTypeName.INFO, "用tagname查找元素" + locator);
            return this.driver.findElement(By.tagName(locator));
        } else if (type.equals("linktext")) {
            LoggerDemoOne.Output(LogType.LogTypeName.INFO, "用linktext查找元素" + locator);
            return this.driver.findElement(By.linkText(locator));
        } else if (type.equals("plinktext")) {
            LoggerDemoOne.Output(LogType.LogTypeName.INFO, "用plinktext查找元素" + locator);
    ...
    public List<WebElement> getElementList(String locator, String type) {
        ...
        if (elementList.isEmpty()) {
            LoggerDemoOne.Output(LogType.LogTypeName.INFO, "用" + type + ": |" + locator + "没有找到元素");
//            System.out.println("用" + type + ": " + locator + "没有找到元素");
        } else {
//            System.out.println("元素用" + type +": " + locator + "找到了！");
            LoggerDemoOne.Output(LogType.LogTypeName.INFO, "元素用" + type + ": |" + locator + "被找到了！");
