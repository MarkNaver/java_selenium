...
class LearningJavaTest {
    ...
    private static final Logger log = LogManager.getLogger(LearningJavaTest.class.getName());
    //高级测试报告
...
//        driver = new ChromeDriver();
        ...
        //高级测试报告
        reports = ExtentFactory.GetInstance(LearningJavaTest.class.getSimpleName());
        //报告的名称
