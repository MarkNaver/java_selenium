...
class LearningJavaTest2 {
    private WebDriver driver;
    private static final Logger log = LogManager.getLogger(LearningJavaTest2.class.getName());
    //高级测试报告
...
//        driver = new ChromeDriver();
        ...
        //高级测试报告
        reports = ExtentFactory.GetInstance(LearningJavaTest2.class.getSimpleName());
        //报告的名称
...
//        WebDriver driver;
        ...
        String baseUrl = "https://www.baidu1.com/";
